...
namespace US_Kalista
{
    public static class Program
    {
        static Obj_AI_Hero _Player = ObjectManager.Player;
        ...
        {
            if (_Player.ChampionName != Config._Champion) return;
            ...
            //Utility.HpBarDamageIndicator.DamageToUnit = Damages.GetRendDamage;// Damages.GetTotalDamage;
